...
public class FidoService {
            ...
            StartRegistrationOptions.builder()
                ...
                .authenticatorSelection(
                    AuthenticatorSelectionCriteria.builder()
                        .authenticatorAttachment(properties.authenticatorAttachment())
  ...
  public AuthenticationResult finishAuthentication(UUID ceremonyId, String credentialJson) {
    return finishAuthentication(ceremonyId, credentialJson, FidoCeremonyEntity.Type.AUTHENTICATION);
  }
  ...
  private AuthenticationResult finishAuthentication(
    ...
    return new AuthenticationResult(credential.getUser().getUsername(), result.isUserVerified());
  }
